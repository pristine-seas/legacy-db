...
```{r}
sections_raw <- read_xlsx(file.path(legacy_path, "Benthic/BENTHIC_TRANSECTS_CORRECTED.xlsx"),
                          sheet         = "Raw",
                          range         = "B1:IH5",
                          col_names     = FALSE,
                          .name_repair  = "minimal") |>
...
sections <- sections_raw |> 
  mutate(depth_m          = parse_number(depth),
         ...
         transect_section = case_when(transect_section == 1 ~ "0-10",
                                      transect_section == 2 ~ "10-20",
                                      transect_section == 3 ~ "20-30",
                                      transect_section == 4 ~ "30-40",
                                      transect_section == 5 ~ "40-50")) |> 
...
contacts_raw <- read_xlsx(file.path(legacy_path, "Benthic/BENTHIC_TRANSECTS_CORRECTED.xlsx"),
                          sheet         = "Raw",
                          range         = "A9:IH86",
                          col_names     = FALSE,
                          .name_repair  = "minimal") 
...
new_worms_records <- purrr::map_dfr(new_taxa$taxon_clean[-20], 
...
new_taxa$rank[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "species"
new_taxa$genus[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Pacifigorgia"
new_taxa$family[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Gorgoniidae"
new_taxa$order[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Malacalcyonacea"
new_taxa$class[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Octocorallia"
new_taxa$phylum[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Cnidaria"
new_taxa$kingdom[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "Animalia"
new_taxa$functional_group[new_taxa$taxon_name == "Pacifigorgia balleni"] <- "soft_coral"
new_taxa$accepted_name[new_taxa$taxon_name == "Pacifigorgia balleni"] <-  "Pacifigorgia balleni"
...
new_taxa <- new_taxa |> filter(!is.na(aphia_id))
...
lpi_taxa$accepted_name[lpi_taxa$morphotaxon == "Pacifigorgia balleni"] <-  "Pacifigorgia balleni"
lpi_taxa$rank[lpi_taxa$morphotaxon == "Pacifigorgia balleni"] <- "species"
lpi_taxa$functional_group[lpi_taxa$morphotaxon == "Pacifigorgia balleni"] <- "soft_coral"
lpi_taxa$family[lpi_taxa$morphotaxon == "Pacifigorgia balleni"] <- "Gorgoniidae"
