---
title: "Taxa Information Dataset"
format: 
  html:
    theme: lux
    self-contained: true
...
The `taxa_info/` dataset is the backbone of biological consistency in the Pristine Seas Science Database. It provides harmonized reference lists and ecological traits for all taxa recorded across expeditions, enabling seamless integration of species-level data across methods, habitats, and years.
...
├── benthos # Sessile benthic taxa from LPI, recruits, photomosaics (e.g., corals, algae, sponges)
├── inverts # Sessile and mobile invertebrates
├── uvs_fish_codes  # Internal field codes for reef fish surveys
```
