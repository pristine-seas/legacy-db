...
sbruv_stations_fields <- tribble(
  ...
  "time_out",      "TIME",   FALSE,    "Recovery time (`HH:MM:SS`)",
  ...
  "bait_type",     "STRING", FALSE,    "Type of bait used (e.g., `sardines`, `skipjack`, `local_fish`)",
  ...
  "partner_code",        "STRING", FALSE,  "Operation code form our partner for this deployment (e.g., `PNGS24_001`)",
  "analysis_status",     "STRING", FALSE,  "Status of video analysis (`rejected`, `pending`, `EM`, `PM`, `EM | PM`)",
  "analysis_notes",     "STRING", FALSE,   "Notes from the partner on the analysis",
)
...
### Detections (`sbruv.detections`) - **In progress**
...
### MaxN by Taxa (`sbruv.maxn_by_taxa`) **In progress**
