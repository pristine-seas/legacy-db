...
pbruv_sites_fields <- tribble(
  ...
  "distance_shore_km",   "FLOAT",   FALSE,     "Average distance from shore across all rigs (km) - calculated",
  
  # Environmental context
  "habitat",             "STRING",  TRUE,      "Water mass/habitat type (`oceanic`, `neritic`, `seamount`, `lagoon`, `channel`)",
...
pbruv_stations_fields <- tribble(
  ...
  "habitat",             "STRING",  TRUE,      "Water mass/habitat type (`oceanic`, `neritic`, `seamount`, `lagoon`, `channel`) - from sites",
