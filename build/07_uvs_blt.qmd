...
blt_stations_fields <- tribble(
  ...
  "date",              "DATE",    TRUE,      "Survey date",
  "time",              "TIME",    TRUE,      "Survey start time (local, 24-hour)",
  ...
  # Summary metrics
  "total_taxa",        "INTEGER", FALSE,     "Total unique fish taxa observed",
  ...
  "density_m2",        "FLOAT",   FALSE,     "Mean fish density (individuals/m²).",
  "biomass_gm2",       "FLOAT",   FALSE,     "Mean biomass (g/m²).",
  "pct_top_predator",  "FLOAT",   FALSE,     "Percentage biomass from top predators",
  "pct_shark",         "FLOAT",   FALSE,     "Average % of total biomass contributed by sharks.",
  "pct_lower_carni",   "FLOAT",   FALSE,     "Average % of total biomass contributed by lower carnivores",
  "pct_herbi_detri",   "FLOAT",   FALSE,     "Average % of total biomass contributed by herbivores/detritivores",
  "pct_plankti",       "FLOAT",   FALSE,     "Average % of total biomass contributed by planktivores",
...
blt_biomass_by_taxa_fields <- tribble(
  ...
  "diver",               "STRING",  TRUE,      "Comma-separated names of divers who conducted the transects.",
  ...
  "mean_length_cm",     "FLOAT",   FALSE,     "Weighted mean total length (cm); weights based on individual counts.",
  ...
  "biomass_gm2",     "FLOAT",   FALSE,     "Mean biomass (g/m²), with zeros imputed for missing transects."
)
