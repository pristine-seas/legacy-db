...
bq_table_create(bq_table(project_id, "lookup", "uvs_fish_codes"),
...
```{r}
write_csv(final_taxa, file.path(prj_path, "data/output/lookup.uvs_fish_codes.csv"))

bq_table_upload(bq_table("pristine-seas", "lookup", "uvs_fish_codes"),
                values = final_taxa,
