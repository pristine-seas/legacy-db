...
# Create table
bq_table_create(bq_table("pristine-seas", "taxonomy", "fish"),
...
fish_taxa |> 
  ...
  write_csv(file.path(prj_path, "data/output/taxonomy.fish.csv"))
```

## Summary

```{r include = T, eval = T}
fish_taxa <-  read_csv(file.path(prj_path, "data/output/taxonomy.fish.csv"))
```
