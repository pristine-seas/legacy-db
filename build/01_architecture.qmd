...
**📂 lookup/** — *Other lookuptables*

- 📄 `researchers`  — Information for researchers and expedition particpant. 
...
- 📄 `stations_unified` — Depth-stratified sampling units within each site joined across all methods (View)
...
- **Fish Belt Transects**
  ...
  - 📄 `blt_biomass_by_station_taxa` — Station-level fish biomass summaries
  
- **Benthic Surveys (LPI)**

  - 📄 `lpi_stations` — Benthic line-point intercept transect metadata
  - 📄 `lpi_observations` — Raw benthic point data by morphotaxon
  - 📄 `lpi_cover_by_station_taxa` — Station-level benthic percent cover
  
- **Inverts Surveys**
  - 📄 `inverts_observations` — Raw invertebrate observations and sizes
  - 📄 `inverts_stations` — Mobile invertebrate transect metadata
  - 📄 `inverts_density_by_station_taxa` — Mobile invertebrate transect metadata
  
- **Coral Recruitment**  
  - 📄 `recruits_counts` — Juvenile coral counts by genus
  - 📄 `recruits_stations` — Coral recruitment quadrat metadata
  - 📄 `recruits_density_by_station_taxa` — Mobile invertebrate transect metadata
...
- 📄 `maxn_by_station_taxa` — Fish MaxN by species and rig
...
- 📄 `maxn_by_station_taxa` — Fish MaxN summaries
