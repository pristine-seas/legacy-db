...
lpi_contacts_fields <- tribble(
  ...
  # Identifiers
  "ps_station_id",     "STRING",  TRUE,      "Foreign key to `uvs.lpi_stations`",
  "exp_id",            "STRING",  TRUE,      "Expedition ID (`ISO3_YEAR`) - denormalized for performance",
  ...
  "transect_length_m", "INTEGER", TRUE,      "Completed transect length (typically 50m)",
  ...
  "accepted_aphia_id", "INTEGER", FALSE,     "WoRMS AphiaID — foreign key to `taxonomy.benthos`",
...
lpi_cover_by_taxa_fields <- tribble(
  ...
  "diver",             "STRING",  TRUE,      "Name of the diver",
  ...
  "accepted_aphia_id", "INTEGER", FALSE,     "WoRMS AphiaID — foreign key to `taxonomy.benthos`",
  "rank",              "STRING",  FALSE,     "Taxonomic rank",
  "family",            "STRING",  FALSE,     "Family of the observed taxon",
  "functional_group",  "STRING",  TRUE,      "Functional group classification",
