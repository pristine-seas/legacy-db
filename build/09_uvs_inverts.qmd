...
```{r eval = T, include = T}
#| label: tbl-inverts-contacts-schema
#| tbl-cap: "uvs.inverts_counts Table Schema"
...
inverts_obs_fields <- tribble(
  ...
  "accepted_aphia_id", "INTEGER", FALSE,     "WoRMS AphiaID — foreign key to `taxonomy.inverts`.",
  "rank",              "STRING",  FALSE,     "Taxonomic rank of the record (`species`, `genus`, or `family`).",
  "family",            "STRING",  FALSE,     "Family of the observed taxon (from `taxonomy.inverts`).",
...
density_by_taxa_fields <- tribble(
  ...
  "density_m2",        "FLOAT",   FALSE,  "Mean density (individuals/m²), standardized by band width and transect length.",
