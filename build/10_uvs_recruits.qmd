...
recruits_stations_fields <- tribble(
  ...
  # Survey effort
  "n_transects",       "INTEGER", TRUE,      "Number of transects surveyed at the station (typically 1 or 2)",
  "survey_dist_m",     "FLOAT",   TRUE,      "Total distance surveyed (m), typically 50m transect",
  "n_quadrats",        "INTEGER", TRUE,      "Number of quadrats surveyed (typically 10)",
  "survey_area_m2",    "FLOAT",   TRUE,      "Total area surveyed (e.g., 2.5 m²)",
  
  # Summary metrics
  "n_taxa",            "INTEGER", TRUE,      "Total number of coral taxa observed",
...
recruits_observations_fields <- tribble(
  ...
  "transect",          "STRING",  TRUE,      "Field-assigned station label (A, B)",
  "transect_length_m", "FLOAT",   TRUE,      "Length of the transect line (typically 50m)",
  ...
  # Taxonomic identity
  "accepted_name",     "STRING",  TRUE,      "Scientific name (typically genus level)",
  ...
  # Observation details
  "count",             "INTEGER", TRUE,      "Number of individual recruits observed in the quadrat of that size class",
  "diameter_cm",       "FLOAT",   TRUE,      "Colony diameter (cm), measured in the field",
...
recruits_density_by_taxa_fields <- tribble(
  ...
  "avg_density_m2",    "FLOAT",   TRUE,      "Recruit density (individuals/m²), standardized by total quadrat area",
  "avg_diameter_cm",   "FLOAT",   TRUE,      "Average diameter of recruits (cm) across all quadrats"
)
...
bq_table_create(bq_table(project_id, "uvs", "recruits_density_by_station_and_taxa"),
